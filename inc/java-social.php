    ...
    <script src="javascripts/kmni/jquery.autolink.js"></script>

    <script src="javascripts/kmni/jquery.timeago.js"></script>

    <script src="javascripts/kmni/jquery.tmpl.js"></script>
